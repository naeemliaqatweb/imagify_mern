            ...
            <motion.form
                ...
                {state != 'Login' &&
                    <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                        ...
                        <input type="text" onChange={(e) => setName(e.target.value) } value={name} placeholder='Full Name' className='outline-none text-sm' required />
                    </div>
                }
                <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                    <img src={assets.email_icon} alt="" />
                    <input type="email" onChange={(e) => setEmail(e.target.value)} value={email} placeholder='Email' className='outline-none text-sm' required />
                </div>
                <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
